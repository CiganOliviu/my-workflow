...
urlpatterns = [
    ...
    path('restapi/personal-projects/<int:pk>', views.PersonalProjectsDetails.as_view(),
         name='DevelopmentStackDetails'),
    path('restapi/personal-finished-projects/', views.PersonalFinishedProjectLister.as_view(),
         name='PersonalFinishedProjectLister'),
    path('restapi/personal-finished-projects/<int:pk>', views.PersonalFinishedProjectDetails.as_view(),
         name='PersonalFinishedProjectDetails'),
